            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="name" placeholder="Digite o nome">
                  @error('name')
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="cpf form-control" type="text" name="cpf" placeholder="Digite o cpf">
                  @error('cpf')
                      <span class="text-danger">{{$message}}</span>
                  @enderror
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="telefone form-control" type="text" name="telefone" placeholder="Digite o telefone">
                  @error('telefone')
                      <span class="text-danger">{{$message}}</span>
                  @enderror
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="date" max="{{date('Y-m-d')}}" name="nascimento">
                  @error('nascimento')
                      <span class="text-danger">{{$message}}</span>
                  @enderror
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="form-control d-flex">
                    <input class="senha w-100 border-0" type="password" id="senha" name="senha" placeholder="Digite a senha">
